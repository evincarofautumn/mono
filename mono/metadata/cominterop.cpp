...
mono_cominterop_init (void)
{
	...
	register_icall ((gpointer)cominterop_get_method_interface, "cominterop_get_method_interface", "ptr ptr", FALSE);
	register_icall ((gpointer)cominterop_get_function_pointer, "cominterop_get_function_pointer", "ptr ptr int32", FALSE);
	register_icall ((gpointer)cominterop_object_is_rcw, "cominterop_object_is_rcw", "int32 object", FALSE);
	register_icall ((gpointer)cominterop_get_ccw, "cominterop_get_ccw", "ptr object ptr", FALSE);
	register_icall ((gpointer)cominterop_get_ccw_object, "cominterop_get_ccw_object", "object ptr int32", FALSE);
	register_icall ((gpointer)cominterop_get_hresult_for_exception, "cominterop_get_hresult_for_exception", "int32 object", FALSE);
	register_icall ((gpointer)cominterop_get_interface, "cominterop_get_interface", "ptr object ptr int32", FALSE);

	register_icall ((gpointer)mono_string_to_bstr, "mono_string_to_bstr", "ptr obj", FALSE);
	register_icall ((gpointer)mono_string_from_bstr, "mono_string_from_bstr", "obj ptr", FALSE);
	register_icall ((gpointer)mono_free_bstr, "mono_free_bstr", "void ptr", FALSE);
	register_icall ((gpointer)cominterop_type_from_handle, "cominterop_type_from_handle", "object ptr", FALSE);

	/* SAFEARRAY marshalling */
	register_icall ((gpointer)mono_marshal_safearray_begin, "mono_marshal_safearray_begin", "int32 ptr ptr ptr ptr ptr int32", FALSE);
	register_icall ((gpointer)mono_marshal_safearray_get_value, "mono_marshal_safearray_get_value", "ptr ptr ptr", FALSE);
	register_icall ((gpointer)mono_marshal_safearray_next, "mono_marshal_safearray_next", "int32 ptr ptr", FALSE);
	register_icall ((gpointer)mono_marshal_safearray_end, "mono_marshal_safearray_end", "void ptr ptr", FALSE);
	register_icall ((gpointer)mono_marshal_safearray_create, "mono_marshal_safearray_create", "int32 object ptr ptr ptr", FALSE);
	register_icall ((gpointer)mono_marshal_safearray_set_value, "mono_marshal_safearray_set_value", "void ptr ptr ptr", FALSE);
	register_icall ((gpointer)mono_marshal_safearray_free_indices, "mono_marshal_safearray_free_indices", "void ptr", FALSE);
}
...
mono_mb_emit_cominterop_call (MonoMethodBuilder *mb, MonoMethodSignature *sig, MonoMethod* method)
{
	...
	mono_mb_emit_icall (mb, (gpointer)cominterop_get_function_pointer);
...
mono_cominterop_emit_ptr_to_object_conv (MonoMethodBuilder *mb, MonoType *type, MonoMarshalConv conv, MonoMarshalSpec *mspec)
{
	...
	case MONO_MARSHAL_CONV_OBJECT_IDISPATCH: {
		...
		mono_mb_emit_icall (mb, (gpointer)cominterop_get_ccw_object);
		...
		mono_mb_emit_icall (mb, (gpointer)cominterop_type_from_handle);
...
mono_cominterop_emit_object_to_ptr_conv (MonoMethodBuilder *mb, MonoType *type, MonoMarshalConv conv, MonoMarshalSpec *mspec)
{
	...
	case MONO_MARSHAL_CONV_OBJECT_IUNKNOWN: {
		...
		mono_mb_emit_ldloc (mb, 0);	
		mono_mb_emit_byte (mb, CEE_LDIND_REF);
		mono_mb_emit_icall (mb, (gpointer)cominterop_object_is_rcw);
		...
		if (conv == MONO_MARSHAL_CONV_OBJECT_INTERFACE) {
			...
			mono_mb_emit_icon (mb, TRUE);
			mono_mb_emit_icall (mb, (gpointer)cominterop_get_interface);
		...
		if (conv == MONO_MARSHAL_CONV_OBJECT_INTERFACE)
			...
			g_assert_not_reached ();
		mono_mb_emit_icall (mb, (gpointer)cominterop_get_ccw);
		mono_mb_emit_byte (mb, CEE_STIND_I);
	...
	*/
	if (MONO_CLASS_IS_IMPORT(method->klass)) {
		...
		if (!strcmp(method->name, ".ctor")) {
			...
			mono_mb_emit_icall (mb, (gpointer)cominterop_get_method_interface);
			mono_mb_emit_icon (mb, TRUE);
			mono_mb_emit_icall (mb, (gpointer)cominterop_get_interface);
...
cominterop_get_ccw (MonoObject* object, MonoClass* itf)
{
	...
	if (!iunknown [0]) {
		iunknown [0] = (gpointer)cominterop_ccw_queryinterface;
		iunknown [1] = (gpointer)cominterop_ccw_addref;
		iunknown [2] = (gpointer)cominterop_ccw_release;
	}

	if (!idispatch [0]) {
		idispatch [0] = (gpointer)cominterop_ccw_get_type_info_count;
		idispatch [1] = (gpointer)cominterop_ccw_get_type_info;
		idispatch [2] = (gpointer)cominterop_ccw_get_ids_of_names;
		idispatch [3] = (gpointer)cominterop_ccw_invoke;
	}
	...
	if (!ccw_entry) {
		...
		vtable = (gpointer *)mono_image_alloc0 (klass->image, sizeof (gpointer)*(method_count+start_slot));
	...
	case MARSHAL_ACTION_CONV_IN: {
		...
		if (t->attrs & PARAM_ATTRIBUTE_IN) {
			...
			*/
			...
			mono_mb_emit_icall (mb, (gpointer)mono_marshal_safearray_create);
			...
			mono_mb_emit_ldloc_addr (mb, elem_var);
			mono_mb_emit_icall (mb, (gpointer)mono_marshal_safearray_set_value);
			...
			mono_mb_emit_ldloc (mb, safearray_var);
			mono_mb_emit_ldloc (mb, indices_var);
			mono_mb_emit_icall (mb, (gpointer)mono_marshal_safearray_next);
			mono_mb_emit_branch_label (mb, CEE_BRTRUE, label3);

			mono_mb_patch_short_branch (mb, label2);

			mono_mb_emit_ldloc (mb, indices_var);
			mono_mb_emit_icall (mb, (gpointer)mono_marshal_safearray_free_indices);
	...
	case MARSHAL_ACTION_CONV_OUT: {
		...
		if (t->attrs & PARAM_ATTRIBUTE_OUT) {
			...
			*/
			...
			mono_mb_emit_icall (mb, (gpointer)mono_marshal_safearray_begin);
			...
			mono_mb_emit_ldloc (mb, conv_arg);
			mono_mb_emit_ldloc (mb, indices_var);
			mono_mb_emit_icall (mb, (gpointer)mono_marshal_safearray_get_value);
			...
			mono_mb_emit_ldloc (mb, conv_arg);
			mono_mb_emit_ldloc (mb, indices_var);
			mono_mb_emit_icall (mb, (gpointer)mono_marshal_safearray_end);
	...
	if (safearray != NULL) {
		...
		if (dim > 0) {
			...
			*indices = g_malloc (dim * sizeof(int));
			...
			sizes = (uintptr_t *)alloca (dim * sizeof(*sizes));
			bounds = (intptr_t *)alloca (dim * sizeof(*bounds));
...
mono_marshal_safearray_create (MonoArray *input, gpointer *newsafearray, gpointer *indices, gpointer empty)
{
	...
	*indices = g_malloc (dim * sizeof (int));
	bounds = (SAFEARRAYBOUND *)alloca (dim * sizeof (*bounds));
...
#else
	if (com_provider == MONO_COM_MS && init_com_provider_ms ()) {
		int hr = safe_array_put_element_ms (safearray, (glong *)indices, (gpointer *)value);
		if (hr < 0) {
			cominterop_raise_hr_exception (hr);
		}
	} else
