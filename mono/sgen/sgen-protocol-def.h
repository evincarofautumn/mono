...
/* Region allocator events. */

BEGIN_PROTOCOL_ENTRY_HEAVY3 (binary_protocol_region_escape_generic, TYPE_POINTER, dst, TYPE_POINTER, obj, TYPE_POINTER, vtable)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->dst ? 0 : ptr == entry->obj ? 1 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (ptr == entry->vtable)
END_PROTOCOL_ENTRY_HEAVY

BEGIN_PROTOCOL_ENTRY_HEAVY3 (binary_protocol_region_escape_major, TYPE_POINTER, dst, TYPE_POINTER, obj, TYPE_POINTER, vtable)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->dst ? 0 : ptr == entry->obj ? 1 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (ptr == entry->vtable)
...
BEGIN_PROTOCOL_ENTRY_HEAVY3 (binary_protocol_region_escape_minor, TYPE_POINTER, dst, TYPE_POINTER, obj, TYPE_POINTER, vtable)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->dst ? 0 : ptr == entry->obj ? 1 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (ptr == entry->vtable)
...
BEGIN_PROTOCOL_ENTRY_HEAVY3 (binary_protocol_region_escape_region, TYPE_POINTER, dst, TYPE_POINTER, obj, TYPE_POINTER, vtable)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->dst ? 0 : ptr == entry->obj ? 1 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (ptr == entry->vtable)
...
BEGIN_PROTOCOL_ENTRY_HEAVY3 (binary_protocol_region_escape_stack, TYPE_POINTER, dst, TYPE_POINTER, obj, TYPE_POINTER, vtable)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->dst ? 0 : ptr == entry->obj ? 1 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (ptr == entry->vtable)
...
BEGIN_PROTOCOL_ENTRY_HEAVY1 (binary_protocol_region_enter, TYPE_POINTER, region)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->region ? 0 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (FALSE)
END_PROTOCOL_ENTRY_HEAVY

BEGIN_PROTOCOL_ENTRY_HEAVY2 (binary_protocol_region_exit, TYPE_POINTER, region, TYPE_SIZE, size)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->region ? 0 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (FALSE)
...
BEGIN_PROTOCOL_ENTRY_HEAVY2 (binary_protocol_region_merge, TYPE_POINTER, current, TYPE_POINTER, parent)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->current ? 0 : ptr == entry->parent ? 1 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (FALSE)
END_PROTOCOL_ENTRY_HEAVY

BEGIN_PROTOCOL_ENTRY_HEAVY2 (binary_protocol_region_clear, TYPE_POINTER, region, TYPE_SIZE, size)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->region ? 0 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (FALSE)
...
BEGIN_PROTOCOL_ENTRY_HEAVY1 (binary_protocol_region_stick, TYPE_POINTER, region)
DEFAULT_PRINT ()
IS_ALWAYS_MATCH (FALSE)
MATCH_INDEX (ptr == entry->region ? 0 : BINARY_PROTOCOL_NO_MATCH)
IS_VTABLE_MATCH (FALSE)
