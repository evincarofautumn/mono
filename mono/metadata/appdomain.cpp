...
shadow_copy_create_ini (const char *shadow, const char *filename)
{
	...
	handle = (HANDLE *)CreateFile (u16_ini, GENERIC_WRITE, FILE_SHARE_READ|FILE_SHARE_WRITE,
...
mono_domain_try_unload (MonoDomain *domain, MonoObject **exc)
{
	...
	prev_state = (MonoAppDomainState)InterlockedCompareExchange ((gint32*)&domain->state, MONO_APPDOMAIN_UNLOADING_START, MONO_APPDOMAIN_CREATED);
