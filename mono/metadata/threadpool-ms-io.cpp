...
#include "threadpool-ms-io-epoll.cpp"
#include "threadpool-ms-io-kqueue.cpp"
#include "threadpool-ms-io-poll.cpp"
...
initialize (void)
{
	...
	if (!mono_thread_create_internal (mono_get_root_domain (), (gpointer)selector_thread, NULL, TRUE, SMALL_STACK))
