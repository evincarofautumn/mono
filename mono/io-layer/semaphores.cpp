...
{
	_wapi_handle_register_capabilities (WAPI_HANDLE_SEM, (WapiHandleCapability)(WAPI_HANDLE_CAP_WAIT | WAPI_HANDLE_CAP_SIGNAL));
	_wapi_handle_register_capabilities (WAPI_HANDLE_NAMEDSEM, (WapiHandleCapability)(WAPI_HANDLE_CAP_WAIT | WAPI_HANDLE_CAP_SIGNAL));
}
