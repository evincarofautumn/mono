...
mono_remoting_marshal_init (void)
{
	...
	if (!icalls_registered) {
		...
		register_icall ((gpointer)mono_marshal_xdomain_copy_value, "mono_marshal_xdomain_copy_value", "object object", FALSE);
...
{
	mono_mb_emit_icall (mb, (gpointer)mono_marshal_xdomain_copy_value);
...
mono_marshal_emit_load_domain_method (MonoMethodBuilder *mb, MonoMethod *method)
{
	 ...
	 */
	mono_mb_emit_ptr (mb, method);
	mono_mb_emit_icall (mb, (gpointer)mono_compile_method);
}
#endif
...
mono_marshal_get_xappdomain_invoke (MonoMethod *method)
{
	...
	mono_mb_emit_icall (mb, (gpointer)mono_context_get);
	mono_mb_emit_byte (mb, CEE_DUP);
	...
	mono_mb_emit_icall (mb, (gpointer)mono_context_set);
...
mono_marshal_get_ldfld_remote_wrapper (MonoClass *klass)
{
	...
	mono_mb_emit_native_call (mb, csig, (gpointer)mono_load_remote_field_new);
	mono_marshal_emit_thread_interrupt_checkpoint (mb);
...
mono_marshal_get_stfld_remote_wrapper (MonoClass *klass)
{
	...
	mono_mb_emit_native_call (mb, csig, (gpointer)mono_store_remote_field_new);
	mono_marshal_emit_thread_interrupt_checkpoint (mb);
