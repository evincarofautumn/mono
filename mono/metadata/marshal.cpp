...
mono_marshal_init (void)
{
	...
	if (!module_initialized) {
		...
		register_icall ((gpointer)ves_icall_System_Threading_Thread_ResetAbort, "ves_icall_System_Threading_Thread_ResetAbort", "void", TRUE);
		register_icall ((gpointer)mono_marshal_string_to_utf16, "mono_marshal_string_to_utf16", "ptr obj", FALSE);
		register_icall ((gpointer)mono_marshal_string_to_utf16_copy, "mono_marshal_string_to_utf16_copy", "ptr obj", FALSE);
		register_icall ((gpointer)mono_string_to_utf16, "mono_string_to_utf16", "ptr obj", FALSE);
		register_icall ((gpointer)mono_string_from_utf16, "mono_string_from_utf16", "obj ptr", FALSE);
		register_icall ((gpointer)mono_string_from_byvalstr, "mono_string_from_byvalstr", "obj ptr int", FALSE);
		register_icall ((gpointer)mono_string_from_byvalwstr, "mono_string_from_byvalwstr", "obj ptr int", FALSE);
		register_icall ((gpointer)mono_string_new_wrapper, "mono_string_new_wrapper", "obj ptr", FALSE);
		register_icall ((gpointer)mono_string_new_len_wrapper, "mono_string_new_len_wrapper", "obj ptr int", FALSE);
		register_icall ((gpointer)mono_string_to_utf8, "mono_string_to_utf8", "ptr obj", FALSE);
		register_icall ((gpointer)mono_string_to_lpstr, "mono_string_to_lpstr", "ptr obj", FALSE);
		register_icall ((gpointer)mono_string_to_ansibstr, "mono_string_to_ansibstr", "ptr object", FALSE);
		register_icall ((gpointer)mono_string_builder_to_utf8, "mono_string_builder_to_utf8", "ptr object", FALSE);
		register_icall ((gpointer)mono_string_builder_to_utf16, "mono_string_builder_to_utf16", "ptr object", FALSE);
		register_icall ((gpointer)mono_array_to_savearray, "mono_array_to_savearray", "ptr object", FALSE);
		register_icall ((gpointer)mono_array_to_lparray, "mono_array_to_lparray", "ptr object", FALSE);
		register_icall ((gpointer)mono_free_lparray, "mono_free_lparray", "void object ptr", FALSE);
		register_icall ((gpointer)mono_byvalarray_to_array, "mono_byvalarray_to_array", "void object ptr ptr int32", FALSE);
		register_icall ((gpointer)mono_byvalarray_to_byte_array, "mono_byvalarray_to_byte_array", "void object ptr int32", FALSE);
		register_icall ((gpointer)mono_array_to_byvalarray, "mono_array_to_byvalarray", "void ptr object ptr int32", FALSE);
		register_icall ((gpointer)mono_array_to_byte_byvalarray, "mono_array_to_byte_byvalarray", "void ptr object int32", FALSE);
		register_icall ((gpointer)mono_delegate_to_ftnptr, "mono_delegate_to_ftnptr", "ptr object", FALSE);
		register_icall ((gpointer)mono_ftnptr_to_delegate, "mono_ftnptr_to_delegate", "object ptr ptr", FALSE);
		register_icall ((gpointer)mono_marshal_asany, "mono_marshal_asany", "ptr object int32 int32", FALSE);
		register_icall ((gpointer)mono_marshal_free_asany, "mono_marshal_free_asany", "void object ptr int32 int32", FALSE);
		register_icall ((gpointer)mono_marshal_alloc, "mono_marshal_alloc", "ptr int32", FALSE);
		register_icall ((gpointer)mono_marshal_free, "mono_marshal_free", "void ptr", FALSE);
		register_icall ((gpointer)mono_marshal_set_last_error, "mono_marshal_set_last_error", "void", FALSE);
		register_icall ((gpointer)mono_marshal_set_last_error_windows, "mono_marshal_set_last_error_windows", "void int32", FALSE);
		register_icall ((gpointer)mono_string_utf8_to_builder, "mono_string_utf8_to_builder", "void ptr ptr", FALSE);
		register_icall ((gpointer)mono_string_utf8_to_builder2, "mono_string_utf8_to_builder2", "object ptr", FALSE);
		register_icall ((gpointer)mono_string_utf16_to_builder, "mono_string_utf16_to_builder", "void ptr ptr", FALSE);
		register_icall ((gpointer)mono_string_utf16_to_builder2, "mono_string_utf16_to_builder2", "object ptr", FALSE);
		register_icall ((gpointer)mono_marshal_free_array, "mono_marshal_free_array", "void ptr int32", FALSE);
		register_icall ((gpointer)mono_string_to_byvalstr, "mono_string_to_byvalstr", "void ptr ptr int32", FALSE);
		register_icall ((gpointer)mono_string_to_byvalwstr, "mono_string_to_byvalwstr", "void ptr ptr int32", FALSE);
		register_icall ((gpointer)g_free, "g_free", "void ptr", FALSE);
		register_icall ((gpointer)mono_object_isinst, "mono_object_isinst", "object object ptr", FALSE);
		register_icall ((gpointer)mono_struct_delete_old, "mono_struct_delete_old", "void ptr ptr", FALSE);
		register_icall ((gpointer)mono_delegate_begin_invoke, "mono_delegate_begin_invoke", "object object ptr", FALSE);
		register_icall ((gpointer)mono_delegate_end_invoke, "mono_delegate_end_invoke", "object object ptr", FALSE);
		register_icall ((gpointer)mono_compile_method, "mono_compile_method", "ptr ptr", FALSE);
		register_icall ((gpointer)mono_context_get, "mono_context_get", "object", FALSE);
		register_icall ((gpointer)mono_context_set, "mono_context_set", "void object", FALSE);
		register_icall ((gpointer)mono_gc_wbarrier_generic_nostore, "wb_generic", "void ptr", FALSE);
		register_icall ((gpointer)mono_gchandle_get_target, "mono_gchandle_get_target", "object int32", TRUE);
		register_icall ((gpointer)mono_marshal_isinst_with_cache, "mono_marshal_isinst_with_cache", "object object ptr ptr", FALSE);

		mono_cominterop_init ();
		mono_remoting_init ();

#ifdef USE_COOP_GC
		register_icall ((gpointer)mono_threads_prepare_blocking, "mono_threads_prepare_blocking", "int", FALSE);
		register_icall ((gpointer)mono_threads_finish_blocking, "mono_threads_finish_blocking", "void int", FALSE);
		register_icall ((gpointer)mono_threads_reset_blocking_start, "mono_threads_reset_blocking_start","int", TRUE);
		register_icall ((gpointer)mono_threads_reset_blocking_end, "mono_threads_reset_blocking_end","void int", TRUE);
#endif
	}
}
...
mono_array_to_lparray (MonoArray *array)
{
	...
	case MONO_TYPE_CLASS:
		...
		nativeArray = (gpointer *)malloc(sizeof(gpointer) * nativeArraySize);
		for(i = 0; i < nativeArraySize; ++i) 	
			nativeArray[i] = ves_icall_System_Runtime_InteropServices_Marshal_GetIUnknownForObjectInternal((MonoObject *)((gpointer*)array->vector)[i]);
		return nativeArray;
	case MONO_TYPE_U1:
...
mono_byvalarray_to_array (MonoArray *arr, gpointer native_arr, MonoClass *elclass, guint32 elnum)
{
	...
	if (elclass == mono_defaults.byte_class) {
		...
		ut = g_utf8_to_utf16 ((gchar *)native_arr, elnum, NULL, &items_written, &error);
...
emit_ptr_to_object_conv (MonoMethodBuilder *mb, MonoType *type, MonoMarshalConv conv, MonoMarshalSpec *mspec)
{
	...
	case MONO_MARSHAL_CONV_ARRAY_BYVALCHARARRAY: {
		...
		mono_mb_emit_ldloc (mb, 0);
		mono_mb_emit_icon (mb, mspec->data.array_data.num_elem);
		mono_mb_emit_icall (mb, (gpointer)mono_byvalarray_to_byte_array);
		break;
	}
	case MONO_MARSHAL_CONV_STR_BYVALSTR: 
		if (mspec && mspec->native == MONO_NATIVE_BYVALTSTR && mspec->data.array_data.num_elem) {
			...
			mono_mb_emit_ldloc (mb, 0);
			mono_mb_emit_icon (mb, mspec->data.array_data.num_elem);
			mono_mb_emit_icall (mb, (gpointer)mono_string_from_byvalstr);
		} else {
			mono_mb_emit_ldloc (mb, 1);
			mono_mb_emit_ldloc (mb, 0);
			mono_mb_emit_icall (mb, (gpointer)mono_string_new_wrapper);
		}
		mono_mb_emit_byte (mb, CEE_STIND_REF);		
		break;
	case MONO_MARSHAL_CONV_STR_BYVALWSTR:
		if (mspec && mspec->native == MONO_NATIVE_BYVALTSTR && mspec->data.array_data.num_elem) {
			...
			mono_mb_emit_ldloc (mb, 0);
			mono_mb_emit_icon (mb, mspec->data.array_data.num_elem);
			mono_mb_emit_icall (mb, (gpointer)mono_string_from_byvalwstr);
		} else {
			mono_mb_emit_ldloc (mb, 1);
			mono_mb_emit_ldloc (mb, 0);
			mono_mb_emit_icall (mb, (gpointer)mono_string_from_utf16);
		}
		mono_mb_emit_byte (mb, CEE_STIND_REF);		
		break;		
	...
	case MONO_MARSHAL_CONV_DEL_FTN: {
		...
		mono_mb_emit_ldloc (mb, 0);
		mono_mb_emit_byte (mb, CEE_LDIND_I);
		mono_mb_emit_icall (mb, (gpointer)mono_ftnptr_to_delegate);
		mono_mb_emit_byte (mb, CEE_STIND_REF);
		break;
	}
...
conv_to_icall (MonoMarshalConv conv)
{
	...
	case MONO_MARSHAL_CONV_LPWSTR_STR:
		return (gpointer)mono_string_from_utf16;
	case MONO_MARSHAL_CONV_LPTSTR_STR:
		return (gpointer)mono_string_new_wrapper;
	...
	case MONO_MARSHAL_CONV_STR_LPTSTR:
		...
		return (gpointer)mono_marshal_string_to_utf16;
#else
		return (gpointer)mono_string_to_lpstr;
#endif
	case MONO_MARSHAL_CONV_STR_LPSTR:
		return (gpointer)mono_string_to_lpstr;
	case MONO_MARSHAL_CONV_STR_BSTR:
	...
	case MONO_MARSHAL_CONV_BSTR_STR:
		return (gpointer)mono_string_from_bstr;
	case MONO_MARSHAL_CONV_STR_TBSTR:
	case MONO_MARSHAL_CONV_STR_ANSIBSTR:
...
emit_object_to_ptr_conv (MonoMethodBuilder *mb, MonoType *type, MonoMarshalConv conv, MonoMarshalSpec *mspec)
{
	...
	case MONO_MARSHAL_CONV_STR_TBSTR: {
		...
		mono_mb_emit_ldloc (mb, 1);
		mono_mb_emit_byte (mb, CEE_LDIND_I);
		mono_mb_emit_icall (mb, (gpointer)g_free);
	...
	case MONO_MARSHAL_CONV_ARRAY_BYVALCHARARRAY: {
		...
		mono_mb_emit_byte (mb, CEE_LDIND_REF);
		mono_mb_emit_icon (mb, mspec->data.array_data.num_elem);
		mono_mb_emit_icall (mb, (gpointer)mono_array_to_byte_byvalarray);
		mono_mb_patch_short_branch (mb, pos);
		break;
	}
	case MONO_MARSHAL_CONV_OBJECT_STRUCT: {
...
emit_struct_free (MonoMethodBuilder *mb, MonoClass *klass, int struct_var)
{
	...
	mono_mb_emit_icall (mb, (gpointer)mono_struct_delete_old);
}
...
mono_marshal_method_from_wrapper (MonoMethod *wrapper)
{
	...
	case MONO_WRAPPER_UNBOX:
		...
		if (wrapper->is_inflated) {
			 ...
			 */
			result = mono_class_inflate_generic_method_checked ((MonoMethod *)res, mono_method_get_context (wrapper), &error);
			g_assert (mono_error_ok (&error)); /* FIXME don't swallow the error */
			return result;
		}
		return (MonoMethod *)res;
	case MONO_WRAPPER_MANAGED_TO_NATIVE:
		info = (WrapperInfo *)mono_marshal_get_wrapper_info (wrapper);
...
mono_marshal_get_delegate_begin_invoke (MonoMethod *method)
{
	...
	mono_mb_emit_ldloc (mb, params_var);
	mono_mb_emit_icall (mb, (gpointer)mono_delegate_begin_invoke);
...
mono_marshal_get_delegate_end_invoke (MonoMethod *method)
{
	...
	mono_mb_emit_ldarg (mb, 0);
	mono_mb_emit_ldloc (mb, params_var);
	mono_mb_emit_icall (mb, (gpointer)mono_delegate_end_invoke);
...
emit_invoke_call (MonoMethodBuilder *mb, MonoMethod *method,
				  ...
				  int loc_res,
				  gboolean is_virtual, gboolean need_direct_wrapper)
{
						  ...
						  gboolean is_virtual, gboolean need_direct_wrapper)
{
	...
	emit_thread_force_interrupt_checkpoint (mb);
	emit_invoke_call (mb, method, sig, callsig, loc_res, is_virtual, need_direct_wrapper);
 ...
 * If IS_VIRTUAL is TRUE, then METHOD is invoked virtually on THIS. This is useful since
...
mono_marshal_get_runtime_invoke (MonoMethod *method, gboolean is_virtual, gboolean pass_rgctx)
{
	...
	name = mono_signature_to_name (callsig, pass_rgctx
		? (is_virtual ? "runtime_invoke_virtual_rgctx" : "runtime_invoke_rgctx")
		: (is_virtual ? "runtime_invoke_virtual" : "runtime_invoke"));
	...
	emit_runtime_invoke_body (mb, target_klass, method, sig, callsig, is_virtual, need_direct_wrapper);
#endif
	...
	if (need_direct_wrapper) {
		...
		mb->skip_visibility = 1;
#endif
		info = mono_wrapper_info_create (mb, is_virtual ? WRAPPER_SUBTYPE_RUNTIME_INVOKE_VIRTUAL : WRAPPER_SUBTYPE_RUNTIME_INVOKE_DIRECT);
...
mono_marshal_get_runtime_invoke_dynamic (void)
{
	...
	mono_mb_emit_icall (mb, (gpointer)ves_icall_System_Threading_Thread_ResetAbort);
					...
					MarshalAction action)
{
	...
	case MARSHAL_ACTION_CONV_IN: {
		...
		mono_mb_emit_icall (mb, (gpointer)mono_marshal_asany);
		mono_mb_emit_stloc (mb, conv_arg);
		break;
	}
	...
	case MARSHAL_ACTION_CONV_OUT: {
		...
		mono_mb_emit_icon (mb, encoding);
		mono_mb_emit_icon (mb, t->attrs);
		mono_mb_emit_icall (mb, (gpointer)mono_marshal_free_asany);
		break;
	}
					...
					MarshalAction action)
{
	...
	case MARSHAL_ACTION_MANAGED_CONV_RESULT:
		...
		mono_mb_emit_icall (mb, (gpointer)mono_marshal_alloc);
		mono_mb_emit_stloc (mb, 1);
		mono_mb_emit_ldloc (mb, 1);
					 ...
					 MarshalAction action)
{
	...
	case MARSHAL_ACTION_CONV_OUT:
		...
		if (encoding == MONO_NATIVE_VBBYREFSTR) {
			...
			mono_mb_emit_icall (mb, (gpointer)mono_string_new_len_wrapper);
			mono_mb_emit_byte (mb, CEE_STIND_REF);
		...
		if (need_free) {
			...
			if (conv == MONO_MARSHAL_CONV_BSTR_STR)
				mono_mb_emit_icall (mb, (gpointer)mono_free_bstr);
			else
				mono_mb_emit_icall (mb, (gpointer)mono_marshal_free);
		}
		break;
	...
	case MARSHAL_ACTION_MANAGED_CONV_RESULT:
		if (conv_to_icall (conv) == mono_marshal_string_to_utf16)
			...
			mono_mb_emit_icall (mb, (gpointer)mono_marshal_string_to_utf16_copy);
		else
			mono_mb_emit_icall (mb, conv_to_icall (conv));
		mono_mb_emit_stloc (mb, 3);
		break;
	...
	case MARSHAL_ACTION_CONV_OUT:
		if (klass == mono_defaults.stringbuilder_class) {
			...
			if (t->byref) {
				...
				switch (encoding) {
				case MONO_NATIVE_LPWSTR:
					mono_mb_emit_icall (mb, (gpointer)mono_string_utf16_to_builder2);
					break;
				case MONO_NATIVE_LPSTR:
					mono_mb_emit_icall (mb, (gpointer)mono_string_utf8_to_builder2);
					break;
				default:
					g_assert_not_reached ();
				}
		...
		*conv_arg_type = &mono_defaults.object_class->byval_arg;
		...
		if (klass->element_class->blittable) {
			...
			if (is_string) {
				...
				/* emit valuetype conversion code */
				emit_struct_conv_full (mb, eklass, FALSE, (MonoMarshalNative)(eklass == mono_defaults.char_class ? encoding : -1));
			}
		...
		if (need_convert || need_free) {
			...
			if (eklass == mono_defaults.stringbuilder_class) {
				...
				if (need_convert) {
					...
					/* emit valuetype conversion code */
					emit_struct_conv_full (mb, eklass, TRUE, (MonoMarshalNative)(eklass == mono_defaults.char_class ? encoding : -1));
				}
...
mono_marshal_emit_native_wrapper (MonoImage *image, MonoMethodBuilder *mb, MonoMethodSignature *sig, MonoMethodPInvoke *piinfo, MonoMarshalSpec **mspecs, gpointer func, gboolean aot, gboolean check_exceptions, gboolean func_param)
{
...
#ifdef USE_COOP_GC
	mono_mb_emit_icall (mb, (gpointer)mono_threads_prepare_blocking);
	...
	if (piinfo->piflags & PINVOKE_ATTRIBUTE_SUPPORTS_LAST_ERROR) {
		...
		mono_mb_emit_icall (mb, (gpointer)mono_marshal_set_last_error_windows);
#else
		mono_mb_emit_icall (mb, (gpointer)mono_marshal_set_last_error);
#endif
	}		

#ifdef USE_COOP_GC
	mono_mb_emit_ldloc (mb, coop_gc_var);
	mono_mb_emit_icall (mb, (gpointer)mono_threads_finish_blocking);
#endif
...
mono_marshal_emit_managed_wrapper (MonoMethodBuilder *mb, MonoMethodSignature *invoke_sig, MonoMarshalSpec **mspecs, EmitMarshalContext* m, MonoMethod *method, uint32_t target_handle)
{
	...
	mono_mb_emit_icall (mb, (gpointer)mono_threads_reset_blocking_start);
	mono_mb_emit_stloc (mb, coop_gc_var);
#endif
	...
	if (sig->hasthis) {
		if (target_handle) {
			...
			mono_mb_emit_icall (mb, (gpointer)mono_gchandle_get_target);
		} else {
			/* fixme: */
			g_assert_not_reached ();
		}
	...
	mono_mb_emit_ldloc (mb, coop_gc_var);
	mono_mb_emit_icall (mb, (gpointer)mono_threads_reset_blocking_end);
#endif
											...
											MonoMethodBuilder *mb)
{
	...
	*cache_hit_pos = mono_mb_emit_branch (mb, CEE_BR);
	...
	mono_mb_emit_ldarg (mb, cache_arg_position);
	mono_mb_emit_icall (mb, (gpointer)mono_marshal_isinst_with_cache);
}
...
get_virtual_stelemref_wrapper (int kind)
{
	...
	case STELEMREF_COMPLEX:
		...
		*/
		...
		mono_mb_emit_icall (mb, (gpointer)mono_object_isinst);
